...
_NON_PROVIDER_FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        "SHOW_FREE_MODELS_FIRST",
        "Show Free Models First",
        "models",
        "boolean",
        settings_attr="show_free_models_first",
        default="true",
        description="When true, free models (determined to be free from providers and from FREE_MODELS_LIST) will appear first in the model list.",
    ),
    ConfigFieldSpec(
        "ONLY_SHOW_FREE_MODELS",
        "Only Show Free Models",
        "models",
        "boolean",
        settings_attr="only_show_free_models",
        default="false",
        description="When true, only free models will appear in the list (determined to be free from providers and from FREE_MODELS_LIST).",
    ),
    ConfigFieldSpec(
        "FREE_MODELS_LIST",
        "Free Models List",
        "models",
        "textarea",
        settings_attr="free_models_list",
        default="",
        description="Comma-separated list of model IDs considered free to use (e.g., nvidia_nim/nvidia/nemotron-3-super-120b-a12b,open_router/openrouter/owl-alpha).",
    ),
    ConfigFieldSpec(
        "REASONING_POLICY",
        "Reasoning Policy",
